...
def plot_post(param_sample_vec, cred_mass=0.95, comp_val=None,
    ...
    post_summary = {'mean':0,'median':0,'mode':0, 'hpd_mass':0,'hpd_low':0,
    ...
    post_summary['hpd_mass'] = cred_mass

    # Compute the HPD, KDE and mode for the posterior
    hpd, x, y, modes = hpd_grid(param_sample_vec, cred_mass, roundto)
    ...
    plt.plot(0, 0, linewidth=8, color='k', label='hpd {:g}%\n{}'.format(cred_mass*100, hpd_label))
